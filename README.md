...
> Lisez le Coran, apprenez les invocations quotidiennes et faites vos adhkar — le tout dans une seule application.
...
- Audio intégré avec plusieurs récitateurs
- Traduction en français, anglais et plus
...
- Duas du matin et du soir
- Duas de la prière, du repas, du sommeil
- Duas de protection et de pardon
...
- Adhkar du sommeil
- **Compteur interactif** pour chaque dhikr
- Sauvegarde automatique de la progression

### 🌟 Général
- 🌙 Verset du jour sur la page d'accueil
- ⚙️ Paramètres (récitateur, traduction)
...
📁 Muslim-App/
├── 📄 index.html ← Page d'accueil (légère)
├── 📄 quran.html          ← Section Coran
├── 📄 duas.html           ← Section Duas
├── 📄 adhkar.html         ← Section Adhkar
├── 📄 style.css           ← Styles partagés
├── 📄 app.js              ← Logique partagé 
├── 📄 manifest.json       ← PWA
...
3. 🐛 Signale un bug dans les Issues
...
Ce projet est libre et open-source. Utilisez-le, partagez-le et améliorez-le pour la communauté.
